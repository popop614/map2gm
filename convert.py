...
object_ids = {
    ...
    'gravdown':(None,25),
    'flipsave':(None,26),
    'sidewaysplatform':(None,27),
    'triplejump':(None,28),
    'doublejump':(None,29),
    'bounce':(None,30),
    'bouncemini':(None,31),
    'bouncedisappear':(None,32),
    'blockflipup':(None,33),
    'blockflipdown':(None,34),
    'upwater':(None,35),
    'downwater':(None,36),
    'shootRIGHT':(None,37),
    'shootLEFT':(None,38),
    ...
    'slantlinea':(None,42),
    'slantlineb':(None,43),
    'waterdisappear':(None,45),
    'dotkidfield':(None,46),
    'dotkidremove':(None,47),
    'minidisappear':(None,48),
    'miniwater1':(None,49),
    'miniwater2':(None,50),
    'miniwater3':(None,51),
    'minitriple':(None,52),
    'minidotkid':(None,53),
    'minidotkidremove':(None,54),
    'miniupwater':(None,55),
    'minidownwater':(None,56),
    'miniflipup':(None,57),
    'miniflipdown':(None,58),
    'watercatharsis':(None,59),
    'minicatharsis':(None,60),
    }
